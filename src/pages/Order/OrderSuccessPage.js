...
//             <input type="text" value={referenceNo} onChange={(e) => setReferenceNo(e.target.value)} placeholder="e.g. PO-12345" className="field-input" />
//           </div>
...
//                 {customer.address && <div className="customer-sub"><MapPin size={12} /> {customer.address}</div>}
//                 {(customer.city || customer.state) && <div className="customer-sub"><Building2 size={12} /> {[customer.city, customer.state].filter(Boolean).join(', ')}</div>}
//               </div>
//             )}
...
//         <button className="primary-btn" onClick={handleViewInvoice} disabled={isConfirming}>
...
//               <textarea placeholder="Delivery Address" value={newAddress} onChange={(e) => setNewAddress(e.target.value)} rows={2} className="modal-input" />
//               <div className="row-inputs">
...
//               <textarea placeholder="Delivery Address" value={editAddress} onChange={(e) => setEditAddress(e.target.value)} rows={2} className="modal-input" />
//               <div className="row-inputs">
...
//             <div className="modal-header">
//               <Check size={18} /> Ready to Generate Invoice?
//               <button className="close-btn" onClick={() => setConfirmVisible(false)}><X size={18} /></button>
//             </div>
//             <div className="modal-body">
//               <p>Please confirm the order details before proceeding.</p>
//               <div className="confirm-info">
//                 <div><strong>Buyer:</strong> {customer?.type === 'shop' ? `${customer.shopName} (${customer.name})` : customer?.name || '—'}</div>
//                 <div><strong>Phone:</strong> {buyerPhone}</div>
//                 <div><strong>Address:</strong> {customer?.address ? [customer.address, customer.city, customer.state].filter(Boolean).join(', ') : '—'}</div>
//                 <div><strong>Salesperson:</strong> {selectedSP?.name || '—'}</div>
//                 <div><strong>Courier:</strong> ₹{courier}</div>
//                 {discountAmount > 0 && <div><strong>Discount:</strong> ₹{discountAmount}</div>}
//                 <div><strong>Grand Total:</strong> ₹{grandTotalWithCourier.toLocaleString('en-IN')}</div>
//               </div>
//               <div className="confirm-buttons">
//                 <button className="primary-btn" onClick={goToInvoice} disabled={isConfirming}>Confirm & Generate Invoice</button>
//                 <button className="outline-btn" onClick={() => setConfirmVisible(false)}>Go Back & Edit</button>
//               </div>
//             </div>
//           </div>
//         </div>
          ...
          <div className="modal-content confirm-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-body">
              ...
              <div className="confirm-info">
                ...
                <div><strong>Address:</strong> <span>{customer?.address ? [customer.address, customer.city, customer.state].filter(Boolean).join(', ') : '—'}</span></div>
